...
class FasterRCNN(TwoStageDetector):
    ...
    def call(self, inputs, training=True, use_dali=False):
        ...
        if training: # get target value for these proposal target label and target delta
            rois_list, rcnn_target_matchs, rcnn_target_deltas, inside_weights, \
                    outside_weights, fg_assignments = self.bbox_target.build_targets(proposals_list, gt_boxes, gt_class_ids, img_metas)
        else:
