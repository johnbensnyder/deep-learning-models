...
from awsdet.utils.misc.misc import is_list_of
from awsdet.utils.image.geometric import imrescale, imresize, imflip, impad, impad_to_multiple
from awsdet.utils.image.photometric import imnormalize
from awsdet.utils.image.colorspace import bgr2hsv, hsv2bgr
...
class RandomFlip(object):
    ...
    def bbox_flip(self, bboxes, img_shape, direction):
        ...
        if direction == 'horizontal':
            ...
            h = img_shape[0]
            flipped[..., 0::4] = h - bboxes[..., 2::4]
            flipped[..., 2::4] = h - bboxes[..., 0::4]
        else:
