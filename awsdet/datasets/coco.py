...
from awsdet.utils.fileio.io import dump
import numpy as np
from awsdet.utils.logger import print_log
...
class CocoDataset(CustomDataset):
    ...
    def yxyx2yxhw(self, bbox):
        """Convert ``yxyx`` style bounding boxes to ``xywh`` style for COCO
        evaluation.
        Args:
    ...
    def _proposal2json(self, results):
        ...
        for idx in range(len(self)):
            ...
            for i in range(bboxes.shape[0]):
                ...
                data['bbox'] = self.yxyx2yxhw(bboxes[i])
